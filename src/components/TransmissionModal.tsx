      ...
      {isOpen && (
        ...
        >
          ...
          >
            ...
            {/* Using a placeholder high-res cyberpunk video since local doesn't exist */}
            <video 
              ref={videoRef}
              src="https://assets.mixkit.co/videos/preview/mixkit-cyberpunk-city-at-night-with-flying-cars-and-neon-lights-42512-large.mp4" 
